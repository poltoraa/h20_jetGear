...
?>
	...
	if($USER->isAdmin()):
	?>
	<?$APPLICATION->ShowViewContent("yandex_delivery");?>
			<?else:?>
                                <div class="card_box_row">
								...
								<?if (!empty($arResult["COLOR_SOPUT_TOVAR"])){?>
									<div class="card_box_col" style="height: 27px; width: 0; text-align: center; font-size: 16px; margin-left: 6px; margin-top: 5px;">
										Цвет:
									</div>

									<div class="card_box_row_elements" style="margin-top: 8px;">
										<div class="card_box_col">
											<ul class="image_preview_col" style="display: inline-block;">
												<?foreach ($arResult["COLOR_SOPUT_TOVAR"] as $key=>$colorElement){
													?>
														<li class="tab_img_element_color" style="width: 41px; height: 41px; float: left; line-height: 0; margin-top: 0; margin-left: 5px;">
															<a href="<?echo SITE_SERVER_NAME.$arResult["SOPUT_DETAIL_PAGE_URL"][$key]?>">
																<img src="<?echo $colorElement['src']?>" width="40" height="40">
															</a>
														</li>
													<?
												}?>
